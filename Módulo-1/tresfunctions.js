...
Você se lembra quando declaramos variáveis ​​para poder usá-las mais tarde? Bem, aqui podemos fazer algo semelhante. Mas, em vez de declarar variáveis ​​(estruturas que contêm informações), podemos declarar funções (estruturas que processam informações).
...
//Lembre-se de que funções são como variáveis, uma vez que as declaramos, podemos usá-las em qualquer lugar. Mesmo dentro de outras funções ;-).
