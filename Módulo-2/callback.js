...
Depois de ter as funções dobro e triplo, é hora de criar a função aplicar. Ao defini-la, lembre-se de que ele recebe um valor e uma função. Esta função terá que ser executada internamente para poder retornar o valor desejado.
